...
// room 2
  if (Firebase.RTDB.setString(&fbdo, "/location1/room1/fire1", fire1)) {
  ...
  if (Firebase.RTDB.setString(&fbdo, "/location1/room3/fire1", fire2)) {
  ...
  if (Firebase.RTDB.setString(&fbdo, "/location1/room1/gas1", gas2)) {
  ...
  if (Firebase.RTDB.setString(&fbdo, "/location1/room2/gas1", gas1)) {
